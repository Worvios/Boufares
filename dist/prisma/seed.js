...
async function main() {
    ...
    const besoin1 = await prisma.besoin.create({
        data: {
            ...
            statut_urgence: client_1.StatutUrgence.URGENT,
    ...
    const besoin2 = await prisma.besoin.create({
        data: {
            ...
            statut_urgence: client_1.StatutUrgence.NORMAL,
            commentaire: null,
        },
    });
    // Create Paiements
    await prisma.paiement.create({
        data: {
            ...
            montant_regle: 2000,
            type_recette: client_1.TypeRecette.VIREMENT,
    ...
    await prisma.paiement.create({
        data: {
            ...
            montant_regle: 3000,
            type_recette: client_1.TypeRecette.CHEQUE,
            mois_concerne: 'Juillet',
        },
    });
}
